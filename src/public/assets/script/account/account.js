...
account.select = async () => {
    let data = await postFetch({url: '/account/getAccountList', body: {}});
...
account.grid = new wGrid('account', {
    fields: [
        ...
        {title:'계좌번호', element: 'text', name: 'acctNum', edit: 'text', width: '38%'},
        {title:'계좌명', element: 'number', name: 'acctNm', edit: 'number', width: '5%'},
        {title:'은행', element: 'text', name: 'bankCd', edit:'select', width: '7%', data: {select:[]}},
        {title:'계좌순번', element: 'number', name: 'acctSeq', edit:'select', width: '7%'},
